...
import com.keling.app.data.local.dao.TaskRecordDao_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `task_records` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `taskId` TEXT NOT NULL, `taskTitle` TEXT NOT NULL, `completeTime` TEXT NOT NULL, `taskType` TEXT, `duration` INTEGER)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `task_record` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `durationMinutes` INTEGER NOT NULL, `createTime` INTEGER NOT NULL, `taskDesc` TEXT, `recordType` TEXT NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'a970925434f5505fd94306223420ddb8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsTaskRecords = new HashMap<String, TableInfo.Column>(6);
        ...
        _columnsTaskRecords.put("completeTime", new TableInfo.Column("completeTime", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecords.put("taskType", new TableInfo.Column("taskType", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecords.put("duration", new TableInfo.Column("duration", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoTaskRecords.equals(_existingTaskRecords)) {
          return new RoomOpenHelper.ValidationResult(false, "task_records(com.keling.app.data.model.TaskRecord).\n"
                  + " Expected:\n" + _infoTaskRecords + "\n"
        ...
        final HashMap<String, TableInfo.Column> _columnsTaskRecord = new HashMap<String, TableInfo.Column>(5);
        _columnsTaskRecord.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecord.put("durationMinutes", new TableInfo.Column("durationMinutes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecord.put("createTime", new TableInfo.Column("createTime", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecord.put("taskDesc", new TableInfo.Column("taskDesc", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTaskRecord.put("recordType", new TableInfo.Column("recordType", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final TableInfo _infoTaskRecord = new TableInfo("task_record", _columnsTaskRecord, _foreignKeysTaskRecord, _indicesTaskRecord);
        final TableInfo _existingTaskRecord = TableInfo.read(db, "task_record");
        if (!_infoTaskRecord.equals(_existingTaskRecord)) {
          return new RoomOpenHelper.ValidationResult(false, "task_record(com.keling.app.data.local.entity.TaskRecordEntity).\n"
                  + " Expected:\n" + _infoTaskRecord + "\n"
                  + " Found:\n" + _existingTaskRecord);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "a970925434f5505fd94306223420ddb8", "030078b704ab7c42900378ac9115ac1a");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "users","courses","schedule_items","chapters","materials","tasks","task_records","team_tasks","task_progress","study_sessions","achievements","user_achievements","badges","user_badges","knowledge_points","knowledge_relations","learning_records","task_record");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `task_record`");
