...
import com.keling.app.di.DatabaseModule_ProvideTaskRecordDaoFactory;
...
import com.keling.app.ui.screens.profile.FriendsViewModel;
import com.keling.app.ui.screens.profile.FriendsViewModel_HiltModules_KeyModule_ProvideFactory;
import com.keling.app.ui.screens.profile.KnowledgeGraphEntryViewModel;
import com.keling.app.ui.screens.profile.KnowledgeGraphEntryViewModel_HiltModules_KeyModule_ProvideFactory;
import com.keling.app.ui.screens.profile.LeaderboardViewModel;
import com.keling.app.ui.screens.profile.LeaderboardViewModel_HiltModules_KeyModule_ProvideFactory;
import com.keling.app.ui.screens.profile.LearningReportViewModel;
import com.keling.app.ui.screens.profile.LearningReportViewModel_HiltModules_KeyModule_ProvideFactory;
import com.keling.app.ui.screens.profile.ProfileViewModel;
import com.keling.app.ui.screens.profile.ProfileViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerKelingApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends KelingApplication_HiltComponents.ViewModelC {
    ...
    private Provider<KnowledgeGraphEntryViewModel> knowledgeGraphEntryViewModelProvider;
    ...
    private Provider<LearningReportViewModel> learningReportViewModelProvider;
    ...
    private TaskRecordRepository taskRecordRepository() {
      return new TaskRecordRepository(singletonCImpl.taskRecordDao());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.friendsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.homeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
      this.knowledgeGraphEntryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 8);
      this.knowledgeGraphViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 9);
      this.knowledgePracticeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 10);
      this.leaderboardViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 11);
      this.learningReportViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 12);
      this.loginViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 13);
      this.personalProfileViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 14);
      ...
      this.taskDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 17);
      this.taskExecutionViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 18);
      this.tasksViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 19);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>builderWithExpectedSize(20).put("com.keling.app.ui.screens.ai.AIAssistantViewModel", ((Provider) aIAssistantViewModelProvider)).put("com.keling.app.ui.screens.settings.AccessibilityViewModel", ((Provider) accessibilityViewModelProvider)).put("com.keling.app.ui.screens.campus.CampusTasksViewModel", ((Provider) campusTasksViewModelProvider)).put("com.keling.app.ui.screens.courses.CourseDetailViewModel", ((Provider) courseDetailViewModelProvider)).put("com.keling.app.ui.screens.courses.CoursesViewModel", ((Provider) coursesViewModelProvider)).put("com.keling.app.ui.screens.focus.FocusViewModel", ((Provider) focusViewModelProvider)).put("com.keling.app.ui.screens.profile.FriendsViewModel", ((Provider) friendsViewModelProvider)).put("com.keling.app.ui.screens.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.keling.app.ui.screens.profile.KnowledgeGraphEntryViewModel", ((Provider) knowledgeGraphEntryViewModelProvider)).put("com.keling.app.ui.screens.knowledge.KnowledgeGraphViewModel", ((Provider) knowledgeGraphViewModelProvider)).put("com.keling.app.ui.screens.knowledge.KnowledgePracticeViewModel", ((Provider) knowledgePracticeViewModelProvider)).put("com.keling.app.ui.screens.profile.LeaderboardViewModel", ((Provider) leaderboardViewModelProvider)).put("com.keling.app.ui.screens.profile.LearningReportViewModel", ((Provider) learningReportViewModelProvider)).put("com.keling.app.ui.screens.login.LoginViewModel", ((Provider) loginViewModelProvider)).put("com.keling.app.ui.screens.settings.PersonalProfileViewModel", ((Provider) personalProfileViewModelProvider)).put("com.keling.app.ui.screens.settings.PrivacySettingsViewModel", ((Provider) privacySettingsViewModelProvider)).put("com.keling.app.ui.screens.profile.ProfileViewModel", ((Provider) profileViewModelProvider)).put("com.keling.app.ui.screens.tasks.TaskDetailViewModel", ((Provider) taskDetailViewModelProvider)).put("com.keling.app.ui.screens.tasks.TaskExecutionViewModel", ((Provider) taskExecutionViewModelProvider)).put("com.keling.app.ui.screens.tasks.TasksViewModel", ((Provider) tasksViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AIAssistantViewModel(singletonCImpl.bindTaskRepositoryProvider.get(), singletonCImpl.bindUserRepositoryProvider.get(), singletonCImpl.provideKelingApiServiceProvider.get());
          ...
          case 6: // com.keling.app.ui.screens.profile.FriendsViewModel 
          ...
          case 8: // com.keling.app.ui.screens.profile.KnowledgeGraphEntryViewModel 
          return (T) new KnowledgeGraphEntryViewModel(singletonCImpl.bindCourseRepositoryProvider.get());

          case 9: // com.keling.app.ui.screens.knowledge.KnowledgeGraphViewModel 
          ...
          case 10: // com.keling.app.ui.screens.knowledge.KnowledgePracticeViewModel 
          ...
          case 11: // com.keling.app.ui.screens.profile.LeaderboardViewModel 
          return (T) new LeaderboardViewModel();

          case 12: // com.keling.app.ui.screens.profile.LearningReportViewModel 
          return (T) new LearningReportViewModel(singletonCImpl.provideKelingApiServiceProvider.get(), singletonCImpl.bindCourseRepositoryProvider.get());

          case 13: // com.keling.app.ui.screens.login.LoginViewModel 
          return (T) new LoginViewModel(singletonCImpl.bindUserRepositoryProvider.get());

          case 14: // com.keling.app.ui.screens.settings.PersonalProfileViewModel 
          return (T) new PersonalProfileViewModel(singletonCImpl.bindUserRepositoryProvider.get());

          case 15: // com.keling.app.ui.screens.settings.PrivacySettingsViewModel 
          return (T) new PrivacySettingsViewModel(singletonCImpl.bindUserRepositoryProvider.get());

          case 16: // com.keling.app.ui.screens.profile.ProfileViewModel 
          return (T) new ProfileViewModel(singletonCImpl.taskRecordDao());

          case 17: // com.keling.app.ui.screens.tasks.TaskDetailViewModel 
          return (T) new TaskDetailViewModel(singletonCImpl.bindTaskRepositoryProvider.get());

          case 18: // com.keling.app.ui.screens.tasks.TaskExecutionViewModel 
          return (T) new TaskExecutionViewModel(singletonCImpl.bindTaskRepositoryProvider.get());

          case 19: // com.keling.app.ui.screens.tasks.TasksViewModel 
          return (T) new TasksViewModel(singletonCImpl.bindTaskRepositoryProvider.get(), viewModelCImpl.taskRecordRepository(), singletonCImpl.bindUserRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends KelingApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideKelingRetrofitProvider = DoubleCheck.provider(new SwitchingProvider<Retrofit>(singletonCImpl, 7));
      this.provideKelingApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<KelingApiService>(singletonCImpl, 6));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 6: // com.keling.app.data.remote.KelingApiService 
          ...
          case 7: // @javax.inject.Named("keling") retrofit2.Retrofit 
